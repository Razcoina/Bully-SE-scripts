...
function MissionSetup()
    ...
    tblPeds = {
        {
            id = nil,
            point = POINTLIST._TJS_EXT_01,
            model = 55,
            path = PATH._TJS_EXT_01
        },
        {
            id = nil,
            point = POINTLIST._TJS_EXT_02,
            model = 4,
            path = PATH._TJS_EXT_02
        },
        {
            id = nil,
            point = POINTLIST._TJS_EXT_03,
            model = 49,
            path = PATH._TJS_EXT_03
        },
        {
            id = nil,
            point = POINTLIST._TJS_EXT_04,
            model = 63,
            path = PATH._TJS_EXT_04
        },
        {
            id = nil,
            point = POINTLIST._TJS_EXT_05,
            model = 64,
            path = PATH._TJS_EXT_05
        },
        {
            id = nil,
            point = POINTLIST._TJS_EXT_06,
            model = 3,
            path = PATH._TJS_EXT_06
        }
    }
end
