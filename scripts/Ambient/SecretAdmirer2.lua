...
local Locker_x, Locker_y, Locker_z = -595.5, -322.4, 5.5
local bPlayerWasGivenChocolates = false

function main()
    --print("()xxxxx[:::::::::::::::> SECRET ADMIRER 2 [start] main()")
    ...
    F_ScenarioCleanup()
    --print("()xxxxx[:::::::::::::::> SECRET ADMIRER 2 [finish] main()")
end
...
function F_ScenarioCleanup()
    --print("()xxxxx[:::::::::::::::> SECRET ADMIRER 2 [start] F_ScenarioCleanup()")
    DoSocialErrands(false)
    --print("F_ScenarioCleanup  ================ Secret Admirer 2")
    ...
    --print("()xxxxx[:::::::::::::::> SECRET ADMIRER 2 [finish] F_ScenarioCleanup()")
end
...
function F_CheckIfPlayerHasChocolates()
    if bPlayerWasGivenChocolates and not PlayerHasItem(478) and not F_PedIsDead(gPlayer) then
        --print("()xxxxx[:::::::::::::::> SECRET ADMIRER 2 - PLAYER HAS 0 CHOCOLATES")
        MinigameSetErrandCompletion(34, "AS_FAIL", false, 0, "AS_TRY_AGAIN")
        return false
    end
    return true
