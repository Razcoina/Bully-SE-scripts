...
local peds = { 67 }
local bActive = false
local px, py, pz = 271.171, -31.5217, 4.79622
local dx, dy, dz = 270.611, -23.6417, 7.96179
...
function main()
    --print("()xxxxx[:::::::::::::::> TAKE ME HOME [start] main()")
    ...
    F_ScenarioCleanup()
    --print("()xxxxx[:::::::::::::::> TAKE ME HOME [finish] main()")
end

function F_ScenarioSetup()
    --print("()xxxxx[:::::::::::::::> TAKE ME HOME [start] F_ScenarioSetup()")
    ...
    --print("()xxxxx[:::::::::::::::> TAKE ME HOME [finish] F_ScenarioSetup()")
end
...
function F_ScenarioCleanup()
    --print("()xxxxx[:::::::::::::::> TAKE ME HOME [start] F_ScenarioCleanup()")
    DoSocialErrands(false)
    ...
    --print("()xxxxx[:::::::::::::::> TAKE ME HOME [finish] F_ScenarioCleanup()")
end
