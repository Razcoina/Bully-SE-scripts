...
function main()
    --print("()xxxxx[:::::::::::::::> BOG ROLL [start] main()")
    ...
    F_ScenarioCleanup()
    --print("()xxxxx[:::::::::::::::> BOG ROLL [finish] main()")
end

function F_ScenarioSetup()
    --print("()xxxxx[:::::::::::::::> BOG ROLL [start] F_ScenarioSetup()")
    ...
    if PedIsValid(ScenarioPed) then
        ...
        --print("()xxxxx[:::::::::::::::> BOG ROLL - Create Ped")
        return true
    else
        return false
    end
    --print("()xxxxx[:::::::::::::::> BOG ROLL [finish] F_ScenarioSetup()")
end
...
function F_ScenarioCleanup()
    --print("()xxxxx[:::::::::::::::> BOGROLL [start] F_ScenarioCleanup()")
    MissionTimerStop()
    DoSocialErrands(false)
    BlipRemove(TPBlip)
    if AreaGetVisible() == 2 then
    ...
    --print("()xxxxx[:::::::::::::::>  BOGROLL [finish] F_ScenarioCleanup()")
end
