...
function main()
    ...
    elseif bMissionPassed then
        ...
        --print("==========> Passed 4B1 - all crates now spawn Brockets")
...
function F_Stage1_Setup()
    ...
    while not PedIsPlaying(pedEarnest.id, "/Global/Ambient/MissionSpec/GetOnCannon", true) do
        ...
        --print("setting /Global/Ambient/MissionSpec/GetOnCannon")
        Wait(0)
    end
...
function F_Stage3_Setup()
    ...
    table.insert(gun_points, POINTLIST._4_B1_STAGE03_GUN03)
...
function F_NIS_01()
    ...
    Wait(1500)
    CameraAllowChange(true)
    --print("()xxxxx[:::::::::::::::> [finish] F_NIS_01()")
end

function F_NIS_02()
    --print("()xxxxx[:::::::::::::::> [start] F_NIS_02()")
    CameraSetWidescreen(true)
    PlayerSetControl(0)
...
function T_EarnestStage2()
    --print("()xxxxx[:::::::::::::::> [start] T_EarnestStage2()")
    ...
    collectgarbage()
    --print("()xxxxx[:::::::::::::::> [finish] T_EarnestStage2()")
end
...
function T_EarnestStage3()
    ...
    collectgarbage()
    --print("()xxxxx[:::::::::::::::> [finish] T_EarnestStage3()")
end

function T_MonitorPlayerHealth()
    --print("()xxxxx[:::::::::::::::> [start] T_MonitorPlayerHealth()")
    ...
    collectgarbage()
    --print("()xxxxx[:::::::::::::::> [finish] T_MonitorPlayerHealth()")
end
