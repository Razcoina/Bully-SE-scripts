...
function F_SetupGym()
	...
	--print("()xxxxx[:::::::::::::::> [finish] F_SetupGym()")
end

function F_StartCheerRoutine()
	--print("()xxxxx[:::::::::::::::> [start] F_StartCheerRoutine()")
	...
	--print("()xxxxx[:::::::::::::::> [finish] F_StartCheerRoutine()")
end

function F_StopCheerRoutine()
	--print("()xxxxx[:::::::::::::::> [start] F_StopCheerRoutine()")
	...
	--print("()xxxxx[:::::::::::::::> [finish] F_StopCheerRoutine()")
end

function F_EarnestReceivedPhotos()
	--print("()xxxxx[:::::::::::::::> [start] F_EarnestReceivedPhotos()")
	bEarnestLeave = true
	--print("()xxxxx[:::::::::::::::> [finish] F_EarnestReceivedPhotos()")
end

function F_PlayerGavePhotos()
	--print("()xxxxx[:::::::::::::::> [start] F_PlayerGavePhotos()")
	bClosingDialogue = true
	--print("()xxxxx[:::::::::::::::> [finish] F_PlayerGavePhotos()")
end

function F_MandyStartWashing()
	--print("()xxxxx[:::::::::::::::> [start] F_MandyStartWashing()")
	PedSetActionNode(pedMandyShower.id, "/Global/4_01/Anims/Showering/Wash01", "Act/Conv/4_01.act")
	--print("()xxxxx[:::::::::::::::> [finish] F_MandyStartWashing()")
end

function F_MandyStopWashing()
	--print("()xxxxx[:::::::::::::::> [start] F_MandyStopWashing()")
	PedSetActionNode(pedMandyShower.id, "/Global/4_01/Anims/Empty", "Act/Conv/4_01.act")
	--print("()xxxxx[:::::::::::::::> [finish] F_MandyStopWashing()")
end

function F_CreateShowerSteam()
	--print("()xxxxx[:::::::::::::::> [start] F_CreateShowerSteam()")
	...
	--print("()xxxxx[:::::::::::::::> [finish] F_CreateShowerSteam()")
end

function F_KillShowerSteam()
	--print("()xxxxx[:::::::::::::::> [start] F_KillShowerSteam()")
	...
	--print("()xxxxx[:::::::::::::::> [finish] F_KillShowerSteam()")
end

function F_MandySawPlayerFromShower()
	--print("()xxxxx[:::::::::::::::> [start] F_MandySawPlayerFromShower()")
	...
	--print("()xxxxx[:::::::::::::::> [finish] F_MandySawPlayerFromShower()")
end

function F_MandySawPlayerFromBedroom()
	--print("()xxxxx[:::::::::::::::> [start] F_MandySawPlayerFromBedroom()")
	SoundFadeWithCamera(false)
	MusicFadeWithCamera(false)
	PlayerSetControl(0)
	CameraFade(500, 0)
	...
	gMissionFailMessage = 2
	bMissionFailed = true
	--print("()xxxxx[:::::::::::::::> [finish] F_MandySawPlayerFromBedroom()")
end

function F_MandyBustedPlayerInGym()
	--print("()xxxxx[:::::::::::::::> [start] F_MandyBustedPlayerInGym()")
	SoundFadeWithCamera(false)
	MusicFadeWithCamera(false)
	PlayerSetControl(0)
	CameraFade(500, 0)
	...
	PlayerSetPunishmentPoints(PlayerGetPunishmentPoints() + 200)
	bMissionFailed = true
	--print("()xxxxx[:::::::::::::::> [finish] F_MandyBustedPlayerInGym()")
end
...
function F_ClosingDialogue()
	--print("()xxxxx[:::::::::::::::> [start] F_ClosingDialogue()")
	CameraSetWidescreen(true)
	PlayerSetControl(0)
	F_MakePlayerSafeForNIS(true)
	SoundDisableSpeech_ActionTree()
	...
	--print("()xxxxx[:::::::::::::::> [finish] F_ClosingDialogue()")
end

function T_CheerSpeech()
	--print("()xxxxx[:::::::::::::::> [start] T_CheerSpeech()")
	local gGirlFlag = 0
	...
	--print("()xxxxx[:::::::::::::::> [finish] T_CheerSpeech()")
end
...
function T_MonitorCheerleaders()
	--print("()xxxxx[:::::::::::::::> [start] T_MonitorCheerleaders()")
	...
	--print("()xxxxx[:::::::::::::::> [finish] T_MonitorCheerleaders()")
end

function T_SpeechChristyDorm()
	--print("()xxxxx[:::::::::::::::> [start] T_SpeechChristyDorm()")
	...
	--print("()xxxxx[:::::::::::::::> [finish] T_SpeechChristyDorm()")
end

function T_ResetGirlsDorm()
	--print("()xxxxx[:::::::::::::::> [start] T_ResetGirlsDorm()")
	while AreaGetVisible() ~= 35 do
		Wait(0)
	end
	bLaunchedEunice = false
	bDormFlaggedForReset = true
	--print("()xxxxx[:::::::::::::::> [finish] T_ResetGirlsDorm()")
end

function T_Cutscene01()
	--print("()xxxxx[:::::::::::::::> [start] T_Cutscene01()")
	...
	--print("()xxxxx[:::::::::::::::> [finish] T_Cutscene01()")
end

function F_CutPhotoGym()
	--print("()xxxxx[:::::::::::::::> [start] F_CutPhotoGym()")
	PlayerSetControl(0)
	F_MakePlayerSafeForNIS(true)
	SoundFadeWithCamera(false)
	MusicFadeWithCamera(false)
	...
	--print("()xxxxx[:::::::::::::::> [finish] F_CutPhotoGym()")
end

function F_CutPhotoShower()
	--print("()xxxxx[:::::::::::::::> [start] F_CutPhotoShower()")
	PlayerSetControl(0)
	F_MakePlayerSafeForNIS(true)
	SoundFadeWithCamera(false)
	MusicFadeWithCamera(false)
	...
	SoundFadeWithCamera(true)
	MusicFadeWithCamera(true)
	--print("()xxxxx[:::::::::::::::> [finish] F_CutPhotoShower()")
end

function F_MissionCriticalMandyGym()
	--print("()xxxxx[:::::::::::::::> [start] F_MissionCriticalMandyGym()")
	bPlayerHitMandyInsideGym = true
	--print("()xxxxx[:::::::::::::::> [finish] F_MissionCriticalMandyGym()")
end
...
function cbMandyExitGym(pedID, pathID, nodeID)
	--print("()xxxxx[:::::::::::::::> cbMandyExitGym() @ node: " .. nodeID)
end

function cbGirlsToGymLockerRoom(pedID, pathID, nodeID)
	--print("()xxxxx[:::::::::::::::> cbGirlsToGymLockerRoom() @ node: " .. nodeID)
end

function cbEuniceDownstairs(pedID, pathID, nodeID)
	--print("()xxxxx[:::::::::::::::> cbEuniceDownstairs() @ node: " .. nodeID)
	if nodeID == 5 then
