...
function main()
	...
	while not (AreaGetVisible() ~= 35 or SystemShouldEndScript()) do
		...
		if not MissionActiveSpecific("6_03") then
			if hour == 8 and 20 <= minute and gGirlsPJ == true then
				F_SetGirlsRegular()
			elseif hour == 8 and minute < 20 and gGirlsPJ == false then
				F_SetGirlsPJ()
			elseif 22 < hour or hour < 8 and gGirlsPJ == false then
				F_SetGirlsPJ()
			end
		end
...
function F_HeadPeek()
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] [start] F_HeadPeek()")
	...
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] [finish] F_HeadPeek()")
end

function F_HeadPeek02(lookElem, textType)
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] [start] F_HeadPeek02()")
	...
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] [finish] F_HeadPeek02()")
end

function F_routeGdormHeadmistress(pedID, pathID, nodeID)
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] F_routeGdormHeadmistress() @ node : " .. nodeID)
	...
	if nodeID == 0 or nodeID == 1 or nodeID == 2 or nodeID == 3 or nodeID == 4 or nodeID == 11 or nodeID == 12 or nodeID == 13 or nodeID == 14 or nodeID == 15 or nodeID == 16 then
		--print("()xxxxx[:::::::::::::::> [gdorm.lua] Headmistress Peeking -> " .. nodeID)
		bHeadPeekCheck = true
	end
end

function F_stealthCallbackHeadmistress(pedID)
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] Headmistress spotted Jimmy")
	SoundPlayScriptedSpeechEvent(pedHeadmistress, "M_2_S06", 40)
	shared.gdormHeadSpottedPlayer = true
end

function F_StopHeadmistress()
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] Stopping Headmistress, moving her to her 'safe spot' downstairs.")
	PedStop(pedHeadmistress)
...
function F_StartHeadmistress()
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] Starting Headmistress, resuming path from downstairs node 16.")
...
function F_DisableTeacherModels()
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] [start] F_DisableTeacherModels()")
	...
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] [finish] F_DisableTeacherModels()")
end

function F_EnableTeacherModels()
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] [start] F_EnableTeacherModels()")
	...
	--print("()xxxxx[:::::::::::::::> [gdorm.lua] [finish] F_EnableTeacherModels()")
end
